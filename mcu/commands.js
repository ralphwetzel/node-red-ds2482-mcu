/*
    This file is from DS2482 Onewire Bridge
...
cmds.SET_READ_POINTER = 0xE1;

cmds.REGISTERS = Object.freeze({
  STATUS: 0xF0,
  DATA: 0xE1,
  CHANNEL: 0xD2,
  CONFIG: 0xC3,
...
cmds.CHANNEL_SELECT = 0xC3;

cmds.SELECTION_CODES = Object.freeze([
  Object.freeze({ write: 0xF0, read: 0xB8 }),
  Object.freeze({ write: 0xE1, read: 0xB1 }),
  Object.freeze({ write: 0xD2, read: 0xAA }),
  Object.freeze({ write: 0xC3, read: 0xA3 }),
  Object.freeze({ write: 0xB4, read: 0x9C }),
  Object.freeze({ write: 0xA5, read: 0x95 }),
  Object.freeze({ write: 0x96, read: 0x8E }),
  Object.freeze({ write: 0x87, read: 0x87 }),
]);
...
cmds.ONE_WIRE_SKIP_ROM = 0xCC;


cmds.ONE_WIRE_RESUME_COMMAND = 0xA5;

cmds.ONE_WIRE_OVERDRIVE_MATCH_ROM = 0x69;
cmds.ONE_WIRE_OVERDRIVE_SKIP_ROM = 0x3C;
